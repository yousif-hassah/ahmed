...
//       <div className="absolute -left-20 -bottom-20 w-80 h-80 rounded-full bg-white opacity-10"></div>

//       <div className="container mx-auto px-6 z-10">
//         <div className="max-w-3xl mx-auto text-center">
//           <h1 className="text-4xl md:text-6xl font-playfair font-bold mb-6 animate-fade-in">
//             Words that <span className="text-pistachio">Move.</span> Ideas that <span className="text-pistachio">Stick.</span>
//           </h1>
...
//               className="bg-transparent border-2 border-pistachio text-charcoal py-3 px-8 rounded-md hover:bg-pistachio hover:text-white transition-all transform hover:scale-105"
//             >
//               Let's Talk
//             </button>
//           </div>
