            ...
            {/* <div className="bg-gray-800 p-6 rounded-md mb-6">
              ...
              <p className="italic">
                <p>
                  ...
                  advertising and artistic campaigns, developing the visual
                  concept of each campaign and leading its execution through a
                  powerful, narrative-driven approach.{" "}
                </p>

                <p>
                  Since 2023 Creative Director at “Setton – Future Makers” I
                  lead the development of the visual identity and storytelling
                  for children’s worlds, producing educational and entertainment
                  content with a contemporary Iraqi spirit.
                </p>

                <p>
                  Podcast Production & Direction I create audio-visual
                  experiences focused on creativity, writing and directing
                  episodes that transform ideas into genuine, story-driven
                  conversations.
                </p>

                <p>
                  Regional Collaborations I have delivered advertising and
                  narrative projects in collaboration with teams in Saudi Arabia
                  and Egypt, with an approach that balances creative thinking
